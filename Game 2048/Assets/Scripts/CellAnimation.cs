...
public class CellAnimation : MonoBehaviour
{
    ...
    public void Move(Cell from, Cell to, bool isMerging)
    {
        ...
        image.color = from.Value > Cell.WinValue ? ColorManager.Instance.CellColors[Cell.WinValue] : ColorManager.Instance.CellColors[from.Value];
        ...
        if (isMerging)
        {
            ...
            {
                image.color = to.Value > Cell.WinValue ? ColorManager.Instance.CellColors[Cell.WinValue] : ColorManager.Instance.CellColors[to.Value];
    ...
    public void Appear(Cell cell)
    {
        ...
        image.color = cell.Value > Cell.WinValue ? ColorManager.Instance.CellColors[Cell.WinValue] : ColorManager.Instance.CellColors[cell.Value];
